  ...
  return (
    <div className={`min-h-screen ${darkMode ? "bg-slate-900 text-slate-100" : "bg-[#F8FAFC] text-slate-800"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <Para>
          Welcome to The Venture Republic. These Terms of Service (&ldquo;Terms&rdquo;) govern your
          access to and use of theventurerepublic.in and any related services, mobile applications, or
          publications operated by The Venture Republic (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
        ...
        <Section title="1. Acceptance of Terms" darkMode={darkMode}>
          <Para>
            By visiting, reading, or otherwise using The Venture Republic&rsquo;s website, applications,
        ...
        <Section title="2. Use of Content" darkMode={darkMode}>
          <Para>
            All content published on The Venture Republic &mdash; including but not limited to articles,
            analysis, data visualisations, infographics, photographs, video, audio, and design elements
            &mdash; is the exclusive intellectual property of The Venture Republic or its licensors, and
          ...
          <BulletList items={[
            ...
            "Share article links on social media with proper attribution to The Venture Republic",
        ...
        <Section title="4. Intellectual Property" darkMode={darkMode}>
          <Para>
            All intellectual property rights in and to The Venture Republic &mdash; including our brand
            name, logo, taglines, design system, editorial content, databases, and software &mdash; are
            owned by or licensed to The Venture Republic. Nothing in these Terms grants you any right,
          ...
          <Para>
            The Venture Republic name and logo are registered trademarks. You may not use our trademarks
        ...
        <Section title="5. Disclaimer of Warranties" darkMode={darkMode}>
          <Para>
            The Venture Republic provides its services on an &ldquo;as is&rdquo; and &ldquo;as
        ...
        <Section title="6. Limitation of Liability" darkMode={darkMode}>
          <Para>
            To the maximum extent permitted by applicable law, The Venture Republic, its directors,
        ...
        <Section title="7. Third-Party Links &amp; References" darkMode={darkMode}>
          <Para>
            ...
            provided for reference and convenience only. The Venture Republic does not endorse, control,
        ...
        <Section title="8. Governing Law &amp; Dispute Resolution" darkMode={darkMode}>
          <Para>
            ...
            regard to its conflict of law provisions. The courts of Bengaluru, Karnataka, India, shall
            have exclusive jurisdiction over any disputes arising out of or in connection with these Terms
            or your use of The Venture Republic&rsquo;s services.
          </Para>
          <Para>
            Before initiating any legal proceeding, both parties agree to attempt to resolve the dispute
            informally by contacting us at legal@theventurerepublic.in. We will make good-faith efforts
        ...
        <Section title="9. Indemnification" darkMode={darkMode}>
          <Para>
            You agree to indemnify, defend, and hold harmless The Venture Republic and its officers,
        ...
        >
          ...
          <a
            href="mailto:legal@theventurerepublic.in"
