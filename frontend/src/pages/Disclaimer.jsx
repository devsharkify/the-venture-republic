    ...
    <div className={`min-h-screen ${darkMode ? "bg-slate-900 text-slate-100" : "bg-[#F8FAFC] text-slate-800"}`}>
      <div className="max-w-3xl mx-auto px-4 py-10">
        ...
        <nav className="flex items-center gap-2 text-[13px] mb-8" aria-label="Breadcrumb">
          ...
          <span className={darkMode ? "text-slate-300" : "text-slate-600"}>Disclaimer</span>
        </nav>
        ...
        <Para>
          ...
          published by The Venture Republic (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or
          &ldquo;our&rdquo;) on theventurerepublic.in or across any of our associated
        ...
        <Section title="1. Editorial Disclaimer" darkMode={darkMode}>
          <Para>
            ...
            Venture Republic are intended solely for general informational and educational
          ...
          <Para>
            Nothing published on The Venture Republic should be construed as financial advice,
          ...
          <Para>
            ...
            Venture Republic as a publication.
          </Para>
        </Section>
        ...
        <Section title="2. Accuracy &amp; Completeness" darkMode={darkMode}>
          ...
          <Para>
            ...
            at hello@theventurerepublic.in so we can investigate and issue a correction where
            warranted.
          </Para>
        </Section>
        ...
        <Section title="3. Investment Disclaimer" darkMode={darkMode}>
          <Para>
            The Venture Republic is a media company, not a registered investment advisor, broker,
          ...
          <Para>
            The Venture Republic does not hold any SEBI registration and is not regulated as a
        ...
        <Section title="4. Third-Party Links &amp; References" darkMode={darkMode}>
          ...
          <Para>
            The Venture Republic does not endorse, control, or take responsibility for the accuracy,
        ...
        <Section title="5. Forward-Looking Statements" darkMode={darkMode}>
          <Para>
            Certain content on The Venture Republic, including coverage of startup projections,
        ...
        <Section title="6. Affiliate Disclosure" darkMode={darkMode}>
          <Para>
            The Venture Republic may from time to time feature content that includes affiliate
          ...
          <Para>
            ...
            please contact us at hello@theventurerepublic.in.
          </Para>
        </Section>
        ...
        <Section title="7. No Professional Relationship" darkMode={darkMode}>
          <Para>
            Your use of The Venture Republic does not create any professional, advisory, or
            fiduciary relationship between you and The Venture Republic, its journalists, or its
        ...
        <Section title="8. Limitation of Liability" darkMode={darkMode}>
          <Para>
            To the fullest extent permitted by applicable law, The Venture Republic and its
