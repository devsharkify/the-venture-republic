    ...
    <div data-testid="article-page" className={`min-h-screen pb-10 ${darkMode ? "bg-slate-900" : "bg-[#F8FAFC]"}`}>
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-6 lg:grid lg:grid-cols-[260px_1fr_260px] lg:gap-8">
        ...
        <article className="min-w-0">
          ...
          {/* ── Social Share Bar ── */}
          <div className={`flex items-center gap-2 flex-wrap py-3 mb-5 border-b ${darkMode ? "border-slate-800" : "border-slate-200"}`}>
            <span className={`text-[10px] font-black uppercase tracking-[0.16em] mr-1 ${darkMode ? "text-slate-500" : "text-slate-400"}`}>
              Share
            </span>
