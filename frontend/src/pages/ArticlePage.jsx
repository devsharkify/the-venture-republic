  ...
  return (
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        {catLabel && (
          <span className="text-[9px] font-bold uppercase tracking-wider text-[#0052CC] block mb-0.5">{catLabel}</span>
        )}
      ...
      <div className="max-w-screen-xl mx-auto px-4 py-6 lg:grid lg:grid-cols-[260px_1fr_260px] lg:gap-8">
        ...
        <aside className="hidden lg:block">
          <div className={`sticky top-20 rounded-xl p-4 ${darkMode ? "bg-[#111827] border border-slate-800" : "bg-white border border-slate-200"}`}>
            <h3 className={`text-[10px] font-black uppercase tracking-[0.18em] pb-2 mb-3 border-b-2 border-[#0052CC] ${darkMode ? "text-slate-300" : "text-slate-700"}`}>
              Related Stories
            </h3>
