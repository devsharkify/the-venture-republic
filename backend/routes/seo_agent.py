...
async def run_seo_analysis():
    ...
    seo_result = await _llm_call(
        """You are an SEO expert for an Indian news platform called "The Venture Republic" (kaizernews.com).
...
3. "content_gaps": 3-5 trending topics in India/Telangana that The Venture Republic should cover but hasn't yet.
...
Return ONLY valid JSON, no markdown.""",
    ...
    social_result = await _llm_call(
        """You are a social media manager for "The Venture Republic", an Indian news platform.
...
Return ONLY valid JSON.""",
    ...
    trend_result = await _llm_call(
        """You are a digital marketing strategist. Based on these Indian news articles, write a brief SEO strategy report (200-300 words) for "The Venture Republic" covering:
