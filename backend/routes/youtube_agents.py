...
async def run_content_curator():
    ...
    # Gather channel data
    channels_info = [
        "The Venture Republic Telugu (2.75M subs, 9143 videos)",
        ...
        "The Venture Republic Politics (330K subs, 4873 videos)",
        "The Venture Republic Andhra (329K subs, 2093 videos)",
        ...
        "The Venture Republic Prakasam (9.7K subs, 648 videos)",
        "The Venture Republic Telangana (8.6K subs, 2877 videos)",
    ]

    system_prompt = """You are a YouTube Content Curator AI Agent for the The Venture Republic Network — a Telugu news media group with 13 YouTube channels totaling 12M+ subscribers.
...
async def run_performance_analyzer():
    ...
    channels_data = [
        ...
        {"name": "The Venture Republic Telugu", "subs": 2750000, "videos": 9143, "handle": "KaizerNewsTelugu"},
        ...
        {"name": "The Venture Republic Politics", "subs": 330000, "videos": 4873, "handle": "KaizerNewsPolitics"},
        {"name": "The Venture Republic Andhra", "subs": 329000, "videos": 2093, "handle": "KaizerNewsAndhra"},
        ...
        {"name": "The Venture Republic Prakasam", "subs": 9700, "videos": 648, "handle": "KaizerNewsPrakasam112"},
        {"name": "The Venture Republic Telangana", "subs": 8620, "videos": 2877, "handle": "KaizerNewstelangana"},
    ]

    system_prompt = """You are a YouTube Performance Analyzer AI Agent for the The Venture Republic Network. Analyze channel metrics and provide actionable insights.
