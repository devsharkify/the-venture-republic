...
async def generate_seo_for_article(article):
    ...
    result = await _llm(
        """You are an SEO expert for an Indian news website called "The Venture Republic". Generate SEO metadata as JSON:
{"meta_title": "60 chars max, include 'The Venture Republic'", "meta_description": "155 chars max", "keywords": ["5-8 relevant keywords"], "og_title": "65 chars", "og_description": "200 chars", "focus_keyword": "main keyword"}
Return ONLY valid JSON.""",
    ...
    try:
        ...
        seo = {
            "meta_title": f"{title[:50]} | The Venture Republic",
...
async def get_sitemap():
    ...
    base_url = BACKEND_URL or "https://theventurerepublic.in"
    urls = [f'''  <url>
...
async def get_article_schema(article_id: str):
    ...
    schema = {
        ...
        "author": {"@type": "Organization", "name": "The Venture Republic"},
        "publisher": {
            "@type": "Organization", "name": "The Venture Republic",
